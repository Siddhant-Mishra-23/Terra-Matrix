...
export const metadata: Metadata = {
  title: "Error Page | Terra Matrix",
  description: "This is Error Page for Terra Matrix",
  // other metadata
};
                ...
                <div className="mx-auto text-center mb-9">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stopColor="#5C6F2B" stopOpacity="0" />
                        <stop offset="1" stopColor="#5C6F2B" />
                      </linearGradient>
                      <linearGradient
          ...
          >
            ...
            <defs>
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#5C6F2B" />
                <stop offset="1" stopColor="#5C6F2B" stopOpacity="0" />
              </linearGradient>
              <linearGradient
